...
import { projects, openSourceProjects } from "@/lib/data"
  ...
  return (
    <SectionWrapper id="projects" className="max-w-6xl">
      ...
      <motion.h2
        ...
        className="text-6xl md:text-[8rem] font-black uppercase tracking-tighter border-b-[12px] border-foreground mt-24 mb-12 pb-4 leading-none"
      >
        Open Source
      </motion.h2>
